...
galleryRef.innerHTML = (0, _galleryItems.galleryItems).map(({ preview , original , description  })=>`<li style="list-style-type: none">
        <a class="gallery__item" href="${original}">
  <img class="gallery__image" src="${preview}" alt="${description}" />
        </a>
      </li>`).join("");
let lightbox = new (0, _simplelightboxDefault.default)(`.gallery__item`, {
    captionsData: `alt`,
    captionDelay: 250,
